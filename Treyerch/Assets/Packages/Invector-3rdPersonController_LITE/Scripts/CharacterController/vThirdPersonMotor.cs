...
namespace Invector.vCharacterController
{
    public class vThirdPersonMotor : MonoBehaviour
    {
        ...
        public float stationaryDynamicFriction = 1f;
        public float groundedStaticFriction = .25f;
        public float groundedDynamicFriction = .25f;
        public float airBorneStaticFriction = 0f;
        public float airBorneDynamicFriction = 0f;
        ...
        public void Init()
        {
            ...
            frictionPhysics.staticFriction = groundedStaticFriction;
            frictionPhysics.dynamicFriction = groundedDynamicFriction;
            frictionPhysics.frictionCombine = PhysicMaterialCombine.Multiply;

            // prevents the collider from slipping on ramps
            maxFrictionPhysics = new PhysicMaterial();
            maxFrictionPhysics.name = "maxFrictionPhysics";
            maxFrictionPhysics.staticFriction = stationaryStaticFriction;
            maxFrictionPhysics.dynamicFriction = stationaryDynamicFriction;
            maxFrictionPhysics.frictionCombine = PhysicMaterialCombine.Maximum;

            // air physics 
            slippyPhysics = new PhysicMaterial();
            slippyPhysics.name = "slippyPhysics";
            slippyPhysics.staticFriction = airBorneStaticFriction;
            slippyPhysics.dynamicFriction = airBorneDynamicFriction;
        ...
        public virtual void AirControl()
        {
            ...
            if (!didHitRoof && CheckIfRoof())
            {
                didHitRoof = true;

                isJumping = false;
                _rigidbody.velocity = new Vector3(_rigidbody.velocity.x, -_rigidbody.velocity.y / 4, _rigidbody.velocity.z);
            }
        ...
        public bool CheckIfRoof()
        {
            ...
            return Physics.SphereCast(transform.position, colliderRadius, Vector3.up, out _roofInfo, colliderHeight - 0.25f, groundLayer);
        }
